        ...
        StringRequest request = new StringRequest(Request.Method.POST, ConfigT.MOBILE_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(!response.equals("null") || !response.equals("")){
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(SendMessageActivity.this, "Cannot populate mobile numbers", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(SendMessageActivity.this, "Error occurred while populating mobile numbers", Toast.LENGTH_LONG).show();
            }
        }){
            @Override
